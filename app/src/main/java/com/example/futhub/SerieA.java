...
public class SerieA extends AppCompatActivity {
    ...
    String leagueId = "135"; // Serie A Code
    String next = "50";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // pass call to API with league id for Serie A
    ...
    private final ResponseListener listener = new ResponseListener() {
        ...
        public void didFetch(FixtureResponse response, String message) {
            ...
            recyclerView.setLayoutManager(new LinearLayoutManager(SerieA.this,
        ...
        public void didError(String message) {
            dialog.dismiss();
            Toast.makeText(SerieA.this, message, Toast.LENGTH_SHORT).show();
        }
    };
