...
public class UEL extends AppCompatActivity {
    Switch lightSwitch;
    boolean nightMODE;
    ...
    String leagueId = "3"; // Europa League
    String next = "50";
    ...
    private final ResponseListener listener = new ResponseListener() {
        ...
        public void didFetch(FixtureResponse response, String message) {
            ...
            recyclerView.setLayoutManager(new LinearLayoutManager(UEL.this,
        ...
        public void didError(String message) {
            dialog.dismiss();
            Toast.makeText(UEL.this, message, Toast.LENGTH_SHORT).show();
        }
    ...
    public void openStream(View v){
        ...
        if(launchIntent != null){
            ...
            Toast.makeText(UEL.this, "App not detected, redirecting to website", Toast.LENGTH_LONG).show();
